    ...
    <div class="flex items-center justify-center">
        ...
        <div class="flex h-full flex-col justify-center gap-4 p-6">
            <div class="left-0 right-0 inline-block  px-2 py-2.5 sm:px-4">
                <form class="flex flex-col gap-4 pb-4" data-hs-cf-bound="true" method="post" action="{{route('actionlogin')}}">
                @csrf
        ...
        <div class="size-96 ml-10"><img src="{{asset('asset/Login.svg')}}" alt=""></div>
    </div>
</div>
</body>
</html>